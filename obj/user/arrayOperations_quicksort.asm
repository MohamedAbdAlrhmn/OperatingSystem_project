...
void _main(void)
{
  ...
  80003e:	e8 df 17 00 00       	call   801822 <sys_getenvid>
  800043:	89 45 f0             	mov    %eax,-0x10(%ebp)
	int32 parentenvID = sys_getparentenvid();
  800046:	e8 09 18 00 00       	call   801854 <sys_getparentenvid>
  ...
  80005f:	68 20 1f 80 00       	push   $0x801f20
  800064:	ff 75 ec             	pushl  -0x14(%ebp)
  800067:	e8 4b 13 00 00       	call   8013b7 <sget>
  80006c:	83 c4 10             	add    $0x10,%esp
  80006f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	numOfElements = sget(parentenvID,"arrSize") ;
  800072:	83 ec 08             	sub    $0x8,%esp
  800075:	68 24 1f 80 00       	push   $0x801f24
  80007a:	ff 75 ec             	pushl  -0x14(%ebp)
  80007d:	e8 35 13 00 00       	call   8013b7 <sget>
  ...
  800092:	68 2c 1f 80 00       	push   $0x801f2c
  800097:	ff 75 ec             	pushl  -0x14(%ebp)
  80009a:	e8 18 13 00 00       	call   8013b7 <sget>
  ...
  8000b2:	50                   	push   %eax
  8000b3:	68 3a 1f 80 00       	push   $0x801f3a
  8000b8:	e8 c6 12 00 00       	call   801383 <smalloc>
  ...
  800112:	68 49 1f 80 00       	push   $0x801f49
...
void QSort(int *Elements,int NumOfElements, int startIndex, int finalIndex)
{
  ...
  800165:	50                   	push   %eax
  800166:	e8 1c 17 00 00       	call   801887 <sys_get_virtual_time>
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  8002f6:	68 65 1f 80 00       	push   $0x801f65
  ...
  800317:	50                   	push   %eax
  800318:	68 67 1f 80 00       	push   $0x801f67
...
void PrintElements(int *Elements, int NumOfElements)
{
  ...
  800345:	50                   	push   %eax
  800346:	68 6c 1f 80 00       	push   $0x801f6c
...
libmain(int argc, char **argv)
{
  ...
  80035c:	e8 da 14 00 00       	call   80183b <sys_getenvindex>
  ...
  800383:	a3 20 30 80 00       	mov    %eax,0x803020
  ...
  8003a1:	a3 00 30 80 00       	mov    %eax,0x803000
  ...
  8003b1:	a3 00 30 80 00       	mov    %eax,0x803000
  ...
  8003c7:	e8 7c 12 00 00       	call   801648 <sys_disable_interrupt>
	cprintf("**************************************\n");
  8003cc:	83 ec 0c             	sub    $0xc,%esp
  8003cf:	68 88 1f 80 00       	push   $0x801f88
  ...
  8003f5:	52                   	push   %edx
  8003f6:	50                   	push   %eax
  8003f7:	68 b0 1f 80 00       	push   $0x801fb0
  ...
  800426:	52                   	push   %edx
  800427:	50                   	push   %eax
  800428:	68 d8 1f 80 00       	push   $0x801fd8
  ...
  800443:	50                   	push   %eax
  800444:	68 30 20 80 00       	push   $0x802030
  800449:	e8 18 01 00 00       	call   800566 <cprintf>
  80044e:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800451:	83 ec 0c             	sub    $0xc,%esp
  800454:	68 88 1f 80 00       	push   $0x801f88
  800459:	e8 08 01 00 00       	call   800566 <cprintf>
  80045e:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800461:	e8 fc 11 00 00       	call   801662 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800479:	e8 89 13 00 00       	call   801807 <sys_destroy_env>
...
exit(void)
{
  ...
  800487:	83 ec 08             	sub    $0x8,%esp
	sys_exit_env();
  80048a:	e8 de 13 00 00       	call   80186d <sys_exit_env>
}
  80048f:	90                   	nop
  800490:	c9                   	leave  
  800491:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  8004d6:	51                   	push   %ecx
  8004d7:	52                   	push   %edx
  8004d8:	e8 bd 0f 00 00       	call   80149a <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  80052f:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName);
  800532:	a0 24 30 80 00       	mov    0x803024,%al
  ...
  80054e:	50                   	push   %eax
  80054f:	e8 46 0f 00 00       	call   80149a <sys_cputs>
  800554:	83 c4 10             	add    $0x10,%esp

	printProgName = 0;
  800557:	c6 05 24 30 80 00 00 	movb   $0x0,0x803024
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  800569:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  80056c:	c6 05 24 30 80 00 01 	movb   $0x1,0x803024
	va_start(ap, fmt);
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800596:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800599:	e8 aa 10 00 00       	call   801648 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8005b6:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8005b9:	e8 a4 10 00 00       	call   801662 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800603:	e8 a8 16 00 00       	call   801cb0 <__udivdi3>
  ...
  800651:	52                   	push   %edx
  800652:	50                   	push   %eax
  800653:	e8 68 17 00 00       	call   801dc0 <__umoddi3>
  800658:	83 c4 10             	add    $0x10,%esp
  80065b:	05 74 22 80 00       	add    $0x802274,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007ae:	8b 04 85 98 22 80 00 	mov    0x802298(,%eax,4),%eax
  ...
  80088f:	8b 34 9d e0 20 80 00 	mov    0x8020e0(,%ebx,4),%esi
  800896:	85 f6                	test   %esi,%esi
  800898:	75 19                	jne    8008b3 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80089a:	53                   	push   %ebx
  80089b:	68 85 22 80 00       	push   $0x802285
  ...
  8008ae:	e9 49 02 00 00       	jmp    800afc <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8008b3:	56                   	push   %esi
  8008b4:	68 8e 22 80 00       	push   $0x80228e
  ...
  8008df:	75 05                	jne    8008e6 <vprintfmt+0x1a6>
				p = "(null)";
  8008e1:	be 91 22 80 00       	mov    $0x802291,%esi
			if (width > 0 && padc != '-')
...
void InitializeUHeap()
{
  ...
  8012f3:	83 ec 08             	sub    $0x8,%esp
	if(FirstTimeFlag)
  8012f6:	a1 04 30 80 00       	mov    0x803004,%eax
  ...
  801307:	68 f0 23 80 00       	push   $0x8023f0
...
#endif
		FirstTimeFlag = 0;
  801314:	c7 05 04 30 80 00 00 	movl   $0x0,0x803004
  80131b:	00 00 00 
	}
}
  80131e:	90                   	nop
...
void initialize_dyn_block_system()
{
  ...
  80132a:	68 18 24 80 00       	push   $0x802418
  80132f:	6a 21                	push   $0x21
  801331:	68 52 24 80 00       	push   $0x802452
  801336:	e8 92 07 00 00       	call   801acd <_panic>
...
void* malloc(uint32 size)
{
  ...
  80133e:	83 ec 08             	sub    $0x8,%esp
	...
	InitializeUHeap();
  801341:	e8 aa ff ff ff       	call   8012f0 <InitializeUHeap>
	if (size == 0) return NULL ;
  801346:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  80134a:	75 07                	jne    801353 <malloc+0x18>
  80134c:	b8 00 00 00 00       	mov    $0x0,%eax
  801351:	eb 14                	jmp    801367 <malloc+0x2c>
	//==============================================================
	//==============================================================
  ...
  801356:	68 60 24 80 00       	push   $0x802460
  80135b:	6a 39                	push   $0x39
  80135d:	68 52 24 80 00       	push   $0x802452
  801362:	e8 66 07 00 00       	call   801acd <_panic>
...
void free(void* virtual_address)
{
  ...
  801372:	68 88 24 80 00       	push   $0x802488
  801377:	6a 54                	push   $0x54
  801379:	68 52 24 80 00       	push   $0x802452
  80137e:	e8 4a 07 00 00       	call   801acd <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80138c:	88 45 f4             	mov    %al,-0xc(%ebp)
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  80138f:	e8 5c ff ff ff       	call   8012f0 <InitializeUHeap>
	if (size == 0) return NULL ;
  801394:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  801398:	75 07                	jne    8013a1 <smalloc+0x1e>
  80139a:	b8 00 00 00 00       	mov    $0x0,%eax
  80139f:	eb 14                	jmp    8013b5 <smalloc+0x32>
	//==============================================================
  ...
  8013a4:	68 ac 24 80 00       	push   $0x8024ac
  8013a9:	6a 69                	push   $0x69
  8013ab:	68 52 24 80 00       	push   $0x802452
  8013b0:	e8 18 07 00 00       	call   801acd <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8013ba:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8013bd:	e8 2e ff ff ff       	call   8012f0 <InitializeUHeap>
	//==============================================================
  ...
  8013c5:	68 d4 24 80 00       	push   $0x8024d4
  8013ca:	68 86 00 00 00       	push   $0x86
  8013cf:	68 52 24 80 00       	push   $0x802452
  8013d4:	e8 f4 06 00 00       	call   801acd <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8013dc:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8013df:	e8 0c ff ff ff       	call   8012f0 <InitializeUHeap>
	//==============================================================
	// [USER HEAP - USER SIDE] realloc
	// Write your code here, remove the panic and write your code
	panic("realloc() is not implemented yet...!!");
  8013e4:	83 ec 04             	sub    $0x4,%esp
  8013e7:	68 f8 24 80 00       	push   $0x8024f8
  8013ec:	68 b8 00 00 00       	push   $0xb8
  8013f1:	68 52 24 80 00       	push   $0x802452
  8013f6:	e8 d2 06 00 00       	call   801acd <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801404:	68 20 25 80 00       	push   $0x802520
  801409:	68 cc 00 00 00       	push   $0xcc
  80140e:	68 52 24 80 00       	push   $0x802452
  801413:	e8 b5 06 00 00       	call   801acd <_panic>
...
void expand(uint32 newSize)
{
  ...
  801421:	68 44 25 80 00       	push   $0x802544
  801426:	68 d7 00 00 00       	push   $0xd7
  80142b:	68 52 24 80 00       	push   $0x802452
  801430:	e8 98 06 00 00       	call   801acd <_panic>
...
void shrink(uint32 newSize)
{
  ...
  80143e:	68 44 25 80 00       	push   $0x802544
  801443:	68 dc 00 00 00       	push   $0xdc
  801448:	68 52 24 80 00       	push   $0x802452
  80144d:	e8 7b 06 00 00       	call   801acd <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  80145b:	68 44 25 80 00       	push   $0x802544
  801460:	68 e1 00 00 00       	push   $0xe1
  801465:	68 52 24 80 00       	push   $0x802452
  80146a:	e8 5e 06 00 00       	call   801acd <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801481:	8b 5d 14             	mov    0x14(%ebp),%ebx
  801484:	8b 7d 18             	mov    0x18(%ebp),%edi
  801487:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  8014a6:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  8014b8:	e8 b2 ff ff ff       	call   80146f <syscall>
...
sys_cgetc(void)
{
  ...
  8014d2:	e8 98 ff ff ff       	call   80146f <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  8014ef:	e8 7b ff ff ff       	call   80146f <syscall>
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801510:	52                   	push   %edx
  801511:	50                   	push   %eax
  801512:	6a 06                	push   $0x6
  801514:	e8 56 ff ff ff       	call   80146f <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801536:	e8 34 ff ff ff       	call   80146f <syscall>
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  80154f:	6a 08                	push   $0x8
  801551:	e8 19 ff ff ff       	call   80146f <syscall>
...
uint32 sys_calculate_free_frames()
{
  ...
  801568:	6a 09                	push   $0x9
  80156a:	e8 00 ff ff ff       	call   80146f <syscall>
...
uint32 sys_calculate_modified_frames()
{
  ...
  801583:	e8 e7 fe ff ff       	call   80146f <syscall>
...
uint32 sys_calculate_notmod_frames()
{
  ...
  80159c:	e8 ce fe ff ff       	call   80146f <syscall>
  8015a1:	83 c4 18             	add    $0x18,%esp
}
  8015a4:	c9                   	leave  
  8015a5:	c3                   	ret    

008015a6 <sys_free_user_mem>:
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8015b5:	6a 0f                	push   $0xf
  8015b7:	e8 b3 fe ff ff       	call   80146f <syscall>
...
008015c2 <sys_allocate_user_mem>:
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8015d3:	e8 97 fe ff ff       	call   80146f <syscall>
...
void sys_allocate_chunk(uint32 virtual_address, uint32 size, uint32 perms)
{
  ...
  8015ee:	6a 11                	push   $0x11
  8015f0:	e8 7a fe ff ff       	call   80146f <syscall>
...
int sys_pf_calculate_allocated_pages()
{
  ...
  80160a:	e8 60 fe ff ff       	call   80146f <syscall>
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801622:	6a 0d                	push   $0xd
  801624:	e8 46 fe ff ff       	call   80146f <syscall>
...
void sys_scarce_memory()
{
  ...
  80163b:	6a 0e                	push   $0xe
  80163d:	e8 2d fe ff ff       	call   80146f <syscall>
...
sys_disable_interrupt()
{
  ...
  801655:	6a 13                	push   $0x13
  801657:	e8 13 fe ff ff       	call   80146f <syscall>
...
sys_enable_interrupt()
{
  ...
  80166f:	6a 14                	push   $0x14
  801671:	e8 f9 fd ff ff       	call   80146f <syscall>
...
sys_cputc(const char c)
{
  ...
  801694:	50                   	push   %eax
  801695:	6a 15                	push   $0x15
  801697:	e8 d3 fd ff ff       	call   80146f <syscall>
...
sys_clear_ffl()
{
  ...
  8016af:	6a 16                	push   $0x16
  8016b1:	e8 b9 fd ff ff       	call   80146f <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  8016cb:	50                   	push   %eax
  8016cc:	6a 17                	push   $0x17
  8016ce:	e8 9c fd ff ff       	call   80146f <syscall>
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8016e7:	52                   	push   %edx
  8016e8:	50                   	push   %eax
  8016e9:	6a 1a                	push   $0x1a
  8016eb:	e8 7f fd ff ff       	call   80146f <syscall>
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801704:	52                   	push   %edx
  801705:	50                   	push   %eax
  801706:	6a 18                	push   $0x18
  801708:	e8 62 fd ff ff       	call   80146f <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801726:	e8 44 fd ff ff       	call   80146f <syscall>
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  80174e:	50                   	push   %eax
  80174f:	6a 1b                	push   $0x1b
  801751:	e8 19 fd ff ff       	call   80146f <syscall>
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  80176a:	52                   	push   %edx
  80176b:	50                   	push   %eax
  80176c:	6a 1c                	push   $0x1c
  80176e:	e8 fc fc ff ff       	call   80146f <syscall>
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  80178d:	e8 dd fc ff ff       	call   80146f <syscall>
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  8017a6:	52                   	push   %edx
  8017a7:	50                   	push   %eax
  8017a8:	6a 1e                	push   $0x1e
  8017aa:	e8 c0 fc ff ff       	call   80146f <syscall>
...
uint32 	sys_getMaxShares()
{
  ...
  8017c1:	6a 1f                	push   $0x1f
  8017c3:	e8 a7 fc ff ff       	call   80146f <syscall>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8017e1:	e8 89 fc ff ff       	call   80146f <syscall>
...
sys_run_env(int32 envId)
{
  ...
  8017fc:	e8 6e fc ff ff       	call   80146f <syscall>
...
int sys_destroy_env(int32  envid)
{
  ...
  801815:	50                   	push   %eax
  801816:	6a 22                	push   $0x22
  801818:	e8 52 fc ff ff       	call   80146f <syscall>
  80181d:	83 c4 18             	add    $0x18,%esp
}
  801820:	c9                   	leave  
  801821:	c3                   	ret    

00801822 <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  801831:	e8 39 fc ff ff       	call   80146f <syscall>
  801836:	83 c4 18             	add    $0x18,%esp
}
  801839:	c9                   	leave  
  80183a:	c3                   	ret    

0080183b <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  80184a:	e8 20 fc ff ff       	call   80146f <syscall>
  80184f:	83 c4 18             	add    $0x18,%esp
}
  801852:	c9                   	leave  
  801853:	c3                   	ret    

00801854 <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801863:	e8 07 fc ff ff       	call   80146f <syscall>
  801868:	83 c4 18             	add    $0x18,%esp
}
  80186b:	c9                   	leave  
  80186c:	c3                   	ret    

0080186d <sys_exit_env>:
...
void sys_exit_env(void)
{
  ...
  80187c:	e8 ee fb ff ff       	call   80146f <syscall>
...
sys_get_virtual_time()
{
  ...
  8018a0:	e8 ca fb ff ff       	call   80146f <syscall>
...
void sys_move_user_mem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8018cd:	6a 12                	push   $0x12
  8018cf:	e8 9b fb ff ff       	call   80146f <syscall>
...
uint32 sys_rcr2()
{
  ...
  8018e9:	e8 81 fb ff ff       	call   80146f <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80190e:	e8 5c fb ff ff       	call   80146f <syscall>
...
void rsttst()
{
  ...
  801928:	e8 42 fb ff ff       	call   80146f <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801953:	e8 17 fb ff ff       	call   80146f <syscall>
...
void chktst(uint32 n)
{
  ...
  80196e:	e8 fc fa ff ff       	call   80146f <syscall>
...
void inctst()
{
  ...
  801988:	e8 e2 fa ff ff       	call   80146f <syscall>
...
uint32 gettst()
{
  ...
  8019a2:	e8 c8 fa ff ff       	call   80146f <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8019be:	e8 ac fa ff ff       	call   80146f <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8019ef:	e8 7b fa ff ff       	call   80146f <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801a20:	e8 4a fa ff ff       	call   80146f <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801a51:	e8 19 fa ff ff       	call   80146f <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801a80:	e8 ea f9 ff ff       	call   80146f <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801aa3:	e8 c7 f9 ff ff       	call   80146f <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801ac3:	e8 a7 f9 ff ff       	call   80146f <syscall>
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  801ad9:	89 45 f4             	mov    %eax,-0xc(%ebp)
	...
	if (argv0)
  801adc:	a1 5c 31 80 00       	mov    0x80315c,%eax
  801ae1:	85 c0                	test   %eax,%eax
  801ae3:	74 16                	je     801afb <_panic+0x2e>
		cprintf("%s: ", argv0);
  801ae5:	a1 5c 31 80 00       	mov    0x80315c,%eax
  801aea:	83 ec 08             	sub    $0x8,%esp
  801aed:	50                   	push   %eax
  801aee:	68 54 25 80 00       	push   $0x802554
  801af3:	e8 6e ea ff ff       	call   800566 <cprintf>
  ...
  801b06:	50                   	push   %eax
  801b07:	68 59 25 80 00       	push   $0x802559
  801b0c:	e8 55 ea ff ff       	call   800566 <cprintf>
  ...
  801b1d:	50                   	push   %eax
  801b1e:	e8 d8 e9 ff ff       	call   8004fb <vcprintf>
  801b23:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  801b26:	83 ec 08             	sub    $0x8,%esp
  801b29:	6a 00                	push   $0x0
  801b2b:	68 75 25 80 00       	push   $0x802575
  801b30:	e8 c6 e9 ff ff       	call   8004fb <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  801b38:	e8 47 e9 ff ff       	call   800484 <exit>
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  801b57:	68 78 25 80 00       	push   $0x802578
  801b5c:	6a 26                	push   $0x26
  801b5e:	68 c4 25 80 00       	push   $0x8025c4
  ...
  801b76:	e9 c2 00 00 00       	jmp    801c3d <CheckWSWithoutLastIndex+0xfe>
  ...
  801b90:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  801b93:	e9 a2 00 00 00       	jmp    801c3a <CheckWSWithoutLastIndex+0xfb>
		}
		int found = 0;
  801b98:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801b9f:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  801ba6:	eb 69                	jmp    801c11 <CheckWSWithoutLastIndex+0xd2>
			if (myEnv->__uptr_pws[w].empty == 0) {
  801ba8:	a1 20 30 80 00       	mov    0x803020,%eax
  801bad:	8b 88 9c 05 00 00    	mov    0x59c(%eax),%ecx
  801bb3:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801bb6:	89 d0                	mov    %edx,%eax
  801bb8:	01 c0                	add    %eax,%eax
  801bba:	01 d0                	add    %edx,%eax
  801bbc:	c1 e0 03             	shl    $0x3,%eax
  801bbf:	01 c8                	add    %ecx,%eax
  801bc1:	8a 40 04             	mov    0x4(%eax),%al
  801bc4:	84 c0                	test   %al,%al
  801bc6:	75 46                	jne    801c0e <CheckWSWithoutLastIndex+0xcf>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  801bc8:	a1 20 30 80 00       	mov    0x803020,%eax
  801bcd:	8b 88 9c 05 00 00    	mov    0x59c(%eax),%ecx
  ...
  801be9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  801bee:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  801bf0:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801bf3:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  ...
  801c03:	75 09                	jne    801c0e <CheckWSWithoutLastIndex+0xcf>
						== expectedPages[e]) {
					found = 1;
  801c05:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  801c0c:	eb 12                	jmp    801c20 <CheckWSWithoutLastIndex+0xe1>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
  ...
  801c1e:	77 88                	ja     801ba8 <CheckWSWithoutLastIndex+0x69>
					found = 1;
					break;
				}
			}
		...
		if (!found)
  801c20:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801c24:	75 14                	jne    801c3a <CheckWSWithoutLastIndex+0xfb>
			panic(
  801c26:	83 ec 04             	sub    $0x4,%esp
  801c29:	68 d0 25 80 00       	push   $0x8025d0
  801c2e:	6a 3a                	push   $0x3a
  801c30:	68 c4 25 80 00       	push   $0x8025c4
  801c35:	e8 93 fe ff ff       	call   801acd <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  801c3a:	ff 45 f0             	incl   -0x10(%ebp)
  801c3d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801c40:	3b 45 0c             	cmp    0xc(%ebp),%eax
  801c43:	0f 8c 32 ff ff ff    	jl     801b7b <CheckWSWithoutLastIndex+0x3c>
		}
		if (!found)
			panic(
  ...
  801c49:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801c50:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  801c57:	eb 26                	jmp    801c7f <CheckWSWithoutLastIndex+0x140>
		if (myEnv->__uptr_pws[w].empty == 1) {
  801c59:	a1 20 30 80 00       	mov    0x803020,%eax
  801c5e:	8b 88 9c 05 00 00    	mov    0x59c(%eax),%ecx
  ...
  801c72:	8a 40 04             	mov    0x4(%eax),%al
  801c75:	3c 01                	cmp    $0x1,%al
  801c77:	75 03                	jne    801c7c <CheckWSWithoutLastIndex+0x13d>
			actualNumOfEmptyLocs++;
  801c79:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801c7c:	ff 45 e0             	incl   -0x20(%ebp)
  801c7f:	a1 20 30 80 00       	mov    0x803020,%eax
  801c84:	8b 50 74             	mov    0x74(%eax),%edx
  801c87:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801c8a:	39 c2                	cmp    %eax,%edx
  801c8c:	77 cb                	ja     801c59 <CheckWSWithoutLastIndex+0x11a>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  801c91:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  801c94:	74 14                	je     801caa <CheckWSWithoutLastIndex+0x16b>
		panic(
  801c96:	83 ec 04             	sub    $0x4,%esp
  801c99:	68 24 26 80 00       	push   $0x802624
  801c9e:	6a 44                	push   $0x44
  801ca0:	68 c4 25 80 00       	push   $0x8025c4
  801ca5:	e8 23 fe ff ff       	call   801acd <_panic>
