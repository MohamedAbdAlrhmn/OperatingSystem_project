...
void _main(void)
{
  ...
  80003e:	e8 f6 1b 00 00       	call   801c39 <sys_getenvid>
  800043:	89 45 f0             	mov    %eax,-0x10(%ebp)
	int32 parentenvID = sys_getparentenvid();
  800046:	e8 20 1c 00 00       	call   801c6b <sys_getparentenvid>
  ...
  80005f:	68 80 39 80 00       	push   $0x803980
  800064:	ff 75 ec             	pushl  -0x14(%ebp)
  800067:	e8 62 17 00 00       	call   8017ce <sget>
  80006c:	83 c4 10             	add    $0x10,%esp
  80006f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	numOfElements = sget(parentenvID,"arrSize") ;
  800072:	83 ec 08             	sub    $0x8,%esp
  800075:	68 84 39 80 00       	push   $0x803984
  80007a:	ff 75 ec             	pushl  -0x14(%ebp)
  80007d:	e8 4c 17 00 00       	call   8017ce <sget>
  ...
  800092:	68 8c 39 80 00       	push   $0x80398c
  800097:	ff 75 ec             	pushl  -0x14(%ebp)
  80009a:	e8 2f 17 00 00       	call   8017ce <sget>
  ...
  8000b2:	50                   	push   %eax
  8000b3:	68 9a 39 80 00       	push   $0x80399a
  ...
  800126:	68 a4 39 80 00       	push   $0x8039a4
  ...
  80013a:	68 c9 39 80 00       	push   $0x8039c9
  ...
  800159:	68 ce 39 80 00       	push   $0x8039ce
  ...
  800178:	68 d2 39 80 00       	push   $0x8039d2
  ...
  800197:	68 d6 39 80 00       	push   $0x8039d6
  ...
  8001b6:	68 da 39 80 00       	push   $0x8039da
...
int QSort(int *Elements,int NumOfElements, int startIndex, int finalIndex, int kIndex)
{
  ...
  80022f:	50                   	push   %eax
  800230:	e8 69 1a 00 00       	call   801c9e <sys_get_virtual_time>
...
libmain(int argc, char **argv)
{
  ...
  800533:	e8 1a 17 00 00       	call   801c52 <sys_getenvindex>
  ...
  80059e:	e8 bc 14 00 00       	call   801a5f <sys_disable_interrupt>
	cprintf("**************************************\n");
  8005a3:	83 ec 0c             	sub    $0xc,%esp
  8005a6:	68 f8 39 80 00       	push   $0x8039f8
  ...
  8005cc:	52                   	push   %edx
  8005cd:	50                   	push   %eax
  8005ce:	68 20 3a 80 00       	push   $0x803a20
  ...
  8005fd:	52                   	push   %edx
  8005fe:	50                   	push   %eax
  8005ff:	68 48 3a 80 00       	push   $0x803a48
  ...
  80061a:	50                   	push   %eax
  80061b:	68 a0 3a 80 00       	push   $0x803aa0
  800620:	e8 18 01 00 00       	call   80073d <cprintf>
  800625:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800628:	83 ec 0c             	sub    $0xc,%esp
  80062b:	68 f8 39 80 00       	push   $0x8039f8
  800630:	e8 08 01 00 00       	call   80073d <cprintf>
  800635:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800638:	e8 3c 14 00 00       	call   801a79 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800650:	e8 c9 15 00 00       	call   801c1e <sys_destroy_env>
...
exit(void)
{
  ...
  80065e:	83 ec 08             	sub    $0x8,%esp
	sys_exit_env();
  800661:	e8 1e 16 00 00       	call   801c84 <sys_exit_env>
}
  800666:	90                   	nop
  800667:	c9                   	leave  
  800668:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  8006ad:	51                   	push   %ecx
  8006ae:	52                   	push   %edx
  8006af:	e8 fd 11 00 00       	call   8018b1 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800725:	50                   	push   %eax
  800726:	e8 86 11 00 00       	call   8018b1 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  80076d:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800770:	e8 ea 12 00 00       	call   801a5f <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  80078d:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800790:	e8 e4 12 00 00       	call   801a79 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8007da:	e8 35 2f 00 00       	call   803714 <__udivdi3>
  ...
  800828:	52                   	push   %edx
  800829:	50                   	push   %eax
  80082a:	e8 f5 2f 00 00       	call   803824 <__umoddi3>
  80082f:	83 c4 10             	add    $0x10,%esp
  800832:	05 d4 3c 80 00       	add    $0x803cd4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800985:	8b 04 85 f8 3c 80 00 	mov    0x803cf8(,%eax,4),%eax
  ...
  800a66:	8b 34 9d 40 3b 80 00 	mov    0x803b40(,%ebx,4),%esi
  800a6d:	85 f6                	test   %esi,%esi
  800a6f:	75 19                	jne    800a8a <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800a71:	53                   	push   %ebx
  800a72:	68 e5 3c 80 00       	push   $0x803ce5
  ...
  800a85:	e9 49 02 00 00       	jmp    800cd3 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800a8a:	56                   	push   %esi
  800a8b:	68 ee 3c 80 00       	push   $0x803cee
  ...
  800ab6:	75 05                	jne    800abd <vprintfmt+0x1a6>
				p = "(null)";
  800ab8:	be f1 3c 80 00       	mov    $0x803cf1,%esi
			if (width > 0 && padc != '-')
...
void InitializeUHeap()
{
  ...
  8014de:	68 50 3e 80 00       	push   $0x803e50
...
void initialize_dyn_block_system()
{
  ...
  8015ad:	50                   	push   %eax
  8015ae:	e8 42 04 00 00       	call   8019f5 <sys_allocate_chunk>
  ...
  8015be:	50                   	push   %eax
  8015bf:	e8 b7 0a 00 00       	call   80207b <initialize_MemBlocksList>
  ...
  8015ec:	68 75 3e 80 00       	push   $0x803e75
  8015f1:	6a 33                	push   $0x33
  8015f3:	68 93 3e 80 00       	push   $0x803e93
  8015f8:	e8 37 1f 00 00       	call   803534 <_panic>
  ...
  80166b:	68 a0 3e 80 00       	push   $0x803ea0
  801670:	6a 34                	push   $0x34
  801672:	68 93 3e 80 00       	push   $0x803e93
  801677:	e8 b8 1e 00 00       	call   803534 <_panic>
...
void* malloc(uint32 size)
{
  ...
  8016e0:	68 c4 3e 80 00       	push   $0x803ec4
  8016e5:	6a 46                	push   $0x46
  8016e7:	68 93 3e 80 00       	push   $0x803e93
  8016ec:	e8 43 1e 00 00       	call   803534 <_panic>
...
void free(void* virtual_address)
{
  ...
  8016fc:	68 ec 3e 80 00       	push   $0x803eec
  801701:	6a 61                	push   $0x61
  801703:	68 93 3e 80 00       	push   $0x803e93
  801708:	e8 27 1e 00 00       	call   803534 <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801722:	75 0a                	jne    80172e <smalloc+0x21>
  801724:	b8 00 00 00 00       	mov    $0x0,%eax
  801729:	e9 9e 00 00 00       	jmp    8017cc <smalloc+0xbf>
  ...
  80178f:	e8 b4 03 00 00       	call   801b48 <sys_createSharedObject>
  801794:	83 c4 10             	add    $0x10,%esp
  801797:	89 45 e0             	mov    %eax,-0x20(%ebp)
		cprintf("Output is :  %d \n" , result);
  80179a:	83 ec 08             	sub    $0x8,%esp
  80179d:	ff 75 e0             	pushl  -0x20(%ebp)
  8017a0:	68 0f 3f 80 00       	push   $0x803f0f
  8017a5:	e8 93 ef ff ff       	call   80073d <cprintf>
  8017aa:	83 c4 10             	add    $0x10,%esp
		if (result != -1 && result != E_NO_SHARE && result != E_SHARED_MEM_EXISTS)
  8017ad:	83 7d e0 ff          	cmpl   $0xffffffff,-0x20(%ebp)
  8017b1:	74 14                	je     8017c7 <smalloc+0xba>
  8017b3:	83 7d e0 f2          	cmpl   $0xfffffff2,-0x20(%ebp)
  8017b7:	74 0e                	je     8017c7 <smalloc+0xba>
  8017b9:	83 7d e0 f1          	cmpl   $0xfffffff1,-0x20(%ebp)
  8017bd:	74 08                	je     8017c7 <smalloc+0xba>
			return (void*) mem_block->sva;
  8017bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
  8017c2:	8b 40 08             	mov    0x8(%eax),%eax
  8017c5:	eb 05                	jmp    8017cc <smalloc+0xbf>
	}
	return NULL;
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8017d1:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8017d4:	e8 ee fc ff ff       	call   8014c7 <InitializeUHeap>
	//==============================================================
  ...
  8017dc:	68 24 3f 80 00       	push   $0x803f24
  8017e1:	68 ab 00 00 00       	push   $0xab
  8017e6:	68 93 3e 80 00       	push   $0x803e93
  8017eb:	e8 44 1d 00 00       	call   803534 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8017f3:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8017f6:	e8 cc fc ff ff       	call   8014c7 <InitializeUHeap>
	//==============================================================
	// [USER HEAP - USER SIDE] realloc
	// Write your code here, remove the panic and write your code
	panic("realloc() is not implemented yet...!!");
  8017fb:	83 ec 04             	sub    $0x4,%esp
  8017fe:	68 48 3f 80 00       	push   $0x803f48
  801803:	68 ef 00 00 00       	push   $0xef
...
void sfree(void* virtual_address)
{
  ...
  80181b:	68 70 3f 80 00       	push   $0x803f70
  801820:	68 03 01 00 00       	push   $0x103
...
void expand(uint32 newSize)
{
  ...
  801838:	68 94 3f 80 00       	push   $0x803f94
  80183d:	68 0e 01 00 00       	push   $0x10e
...
void shrink(uint32 newSize)
{
  ...
  801855:	68 94 3f 80 00       	push   $0x803f94
  80185a:	68 13 01 00 00       	push   $0x113
...
void freeHeap(void* virtual_address)
{
  ...
  801872:	68 94 3f 80 00       	push   $0x803f94
  801877:	68 18 01 00 00       	push   $0x118
...
void print_mem_block_lists()
{
  ...
  801eed:	68 a4 3f 80 00       	push   $0x803fa4
  801ef2:	e8 46 e8 ff ff       	call   80073d <cprintf>
  ...
  801f04:	68 d0 3f 80 00       	push   $0x803fd0
  801f09:	e8 2f e8 ff ff       	call   80073d <cprintf>
  ...
  801f58:	52                   	push   %edx
  801f59:	50                   	push   %eax
  801f5a:	68 e5 3f 80 00       	push   $0x803fe5
  801f5f:	e8 d9 e7 ff ff       	call   80073d <cprintf>
  ...
  801fa4:	68 f4 3f 80 00       	push   $0x803ff4
  801fa9:	e8 8f e7 ff ff       	call   80073d <cprintf>
  ...
  801fbb:	68 18 40 80 00       	push   $0x804018
  801fc0:	e8 78 e7 ff ff       	call   80073d <cprintf>
  ...
  80200f:	52                   	push   %edx
  802010:	50                   	push   %eax
  802011:	68 e5 3f 80 00       	push   $0x803fe5
  802016:	e8 22 e7 ff ff       	call   80073d <cprintf>
  ...
  80205b:	68 30 40 80 00       	push   $0x804030
  802060:	e8 d8 e6 ff ff       	call   80073d <cprintf>
  802065:	83 c4 10             	add    $0x10,%esp
	cprintf("\n=========================================\n");
  802068:	83 ec 0c             	sub    $0xc,%esp
  80206b:	68 a4 3f 80 00       	push   $0x803fa4
...
void initialize_MemBlocksList(uint32 numOfBlocks)
{
  ...
  8020bf:	68 58 40 80 00       	push   $0x804058
  8020c4:	6a 46                	push   $0x46
  8020c6:	68 7b 40 80 00       	push   $0x80407b
...
void insert_sorted_allocList(struct MemBlock *blockToInsert)
{
  ...
  802201:	68 58 40 80 00       	push   $0x804058
  802206:	6a 6b                	push   $0x6b
  802208:	68 7b 40 80 00       	push   $0x80407b
  ...
  80227c:	68 94 40 80 00       	push   $0x804094
  802281:	6a 6f                	push   $0x6f
  802283:	68 7b 40 80 00       	push   $0x80407b
  ...
  8022f6:	68 cc 40 80 00       	push   $0x8040cc
  8022fb:	6a 73                	push   $0x73
  8022fd:	68 7b 40 80 00       	push   $0x80407b
  ...
  8023a3:	68 f0 40 80 00       	push   $0x8040f0
  8023a8:	6a 7f                	push   $0x7f
  8023aa:	68 7b 40 80 00       	push   $0x80407b
...
struct MemBlock *alloc_block_FF(uint32 size)
{
  ...
  802477:	68 24 41 80 00       	push   $0x804124
  80247c:	68 93 00 00 00       	push   $0x93
  802481:	68 7b 40 80 00       	push   $0x80407b
  ...
  80252d:	68 24 41 80 00       	push   $0x804124
  802532:	68 9b 00 00 00       	push   $0x9b
  802537:	68 7b 40 80 00       	push   $0x80407b
...
struct MemBlock *alloc_block_BF(uint32 size)
{
  ...
  80264b:	68 24 41 80 00       	push   $0x804124
  802650:	68 b7 00 00 00       	push   $0xb7
  802655:	68 7b 40 80 00       	push   $0x80407b
  ...
  80275e:	68 24 41 80 00       	push   $0x804124
  802763:	68 c7 00 00 00       	push   $0xc7
  802768:	68 7b 40 80 00       	push   $0x80407b
...
struct MemBlock *alloc_block_NF(uint32 size)
{
  ...
  802862:	68 24 41 80 00       	push   $0x804124
  802867:	68 e0 00 00 00       	push   $0xe0
  80286c:	68 7b 40 80 00       	push   $0x80407b
  ...
  802923:	68 24 41 80 00       	push   $0x804124
  802928:	68 e9 00 00 00       	push   $0xe9
  80292d:	68 7b 40 80 00       	push   $0x80407b
  ...
  802a53:	68 24 41 80 00       	push   $0x804124
  802a58:	68 fc 00 00 00       	push   $0xfc
  802a5d:	68 7b 40 80 00       	push   $0x80407b
  ...
  802b14:	68 24 41 80 00       	push   $0x804124
  802b19:	68 04 01 00 00       	push   $0x104
  802b1e:	68 7b 40 80 00       	push   $0x80407b
  ...
  802c3f:	68 24 41 80 00       	push   $0x804124
  802c44:	68 14 01 00 00       	push   $0x114
  802c49:	68 7b 40 80 00       	push   $0x80407b
  ...
  802d00:	68 24 41 80 00       	push   $0x804124
  802d05:	68 1c 01 00 00       	push   $0x11c
  802d0a:	68 7b 40 80 00       	push   $0x80407b
...
void insert_sorted_with_merge_freeList(struct MemBlock *blockToInsert)
{
  ...
  802e24:	68 58 40 80 00       	push   $0x804058
  802e29:	68 38 01 00 00       	push   $0x138
  802e2e:	68 7b 40 80 00       	push   $0x80407b
  ...
  802ec1:	68 24 41 80 00       	push   $0x804124
  802ec6:	68 3c 01 00 00       	push   $0x13c
  802ecb:	68 7b 40 80 00       	push   $0x80407b
  ...
  802f57:	68 58 40 80 00       	push   $0x804058
  802f5c:	68 3f 01 00 00       	push   $0x13f
  802f61:	68 7b 40 80 00       	push   $0x80407b
  ...
  803017:	68 58 40 80 00       	push   $0x804058
  80301c:	68 49 01 00 00       	push   $0x149
  803021:	68 7b 40 80 00       	push   $0x80407b
  ...
  80307f:	68 cc 40 80 00       	push   $0x8040cc
  803084:	68 4c 01 00 00       	push   $0x14c
  803089:	68 7b 40 80 00       	push   $0x80407b
  ...
  803170:	68 24 41 80 00       	push   $0x804124
  803175:	68 5c 01 00 00       	push   $0x15c
  80317a:	68 7b 40 80 00       	push   $0x80407b
  ...
  803206:	68 58 40 80 00       	push   $0x804058
  80320b:	68 5f 01 00 00       	push   $0x15f
  803210:	68 7b 40 80 00       	push   $0x80407b
  ...
  803291:	68 58 40 80 00       	push   $0x804058
  803296:	68 64 01 00 00       	push   $0x164
  80329b:	68 7b 40 80 00       	push   $0x80407b
  ...
  80331b:	68 94 40 80 00       	push   $0x804094
  803320:	68 69 01 00 00       	push   $0x169
  803325:	68 7b 40 80 00       	push   $0x80407b
  ...
  803393:	68 24 41 80 00       	push   $0x804124
  803398:	68 6b 01 00 00       	push   $0x16b
  80339d:	68 7b 40 80 00       	push   $0x80407b
  ...
  803429:	68 58 40 80 00       	push   $0x804058
  80342e:	68 6e 01 00 00       	push   $0x16e
  803433:	68 7b 40 80 00       	push   $0x80407b
  ...
  803497:	68 f0 40 80 00       	push   $0x8040f0
  80349c:	68 73 01 00 00       	push   $0x173
  8034a1:	68 7b 40 80 00       	push   $0x80407b
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  803554:	50                   	push   %eax
  803555:	68 44 41 80 00       	push   $0x804144
  80355a:	e8 de d1 ff ff       	call   80073d <cprintf>
  ...
  80356d:	50                   	push   %eax
  80356e:	68 49 41 80 00       	push   $0x804149
  803573:	e8 c5 d1 ff ff       	call   80073d <cprintf>
  ...
  803584:	50                   	push   %eax
  803585:	e8 48 d1 ff ff       	call   8006d2 <vcprintf>
  80358a:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  80358d:	83 ec 08             	sub    $0x8,%esp
  803590:	6a 00                	push   $0x0
  803592:	68 65 41 80 00       	push   $0x804165
  803597:	e8 36 d1 ff ff       	call   8006d2 <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  80359f:	e8 b7 d0 ff ff       	call   80065b <exit>
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8035be:	68 68 41 80 00       	push   $0x804168
  8035c3:	6a 26                	push   $0x26
  8035c5:	68 b4 41 80 00       	push   $0x8041b4
  ...
  803690:	68 c0 41 80 00       	push   $0x8041c0
  803695:	6a 3a                	push   $0x3a
  803697:	68 b4 41 80 00       	push   $0x8041b4
  ...
  803700:	68 14 42 80 00       	push   $0x804214
  803705:	6a 44                	push   $0x44
  803707:	68 b4 41 80 00       	push   $0x8041b4
