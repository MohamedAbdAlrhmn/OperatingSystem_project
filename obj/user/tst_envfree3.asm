...
void _main(void)
{
  ...
  80004a:	e8 53 13 00 00       	call   8013a2 <smalloc>
  ...
  80005e:	e8 17 15 00 00       	call   80157a <sys_calculate_free_frames>
  800063:	89 45 f0             	mov    %eax,-0x10(%ebp)
	int usedDiskPages_before = sys_pf_calculate_allocated_pages() ;
  800066:	e8 af 15 00 00       	call   80161a <sys_pf_calculate_allocated_pages>
  ...
  800099:	e8 4e 17 00 00       	call   8017ec <sys_create_env>
  ...
  8000b7:	68 6c 1e 80 00       	push   $0x801e6c
  8000bc:	e8 2b 17 00 00       	call   8017ec <sys_create_env>
  ...
  8000cd:	e8 38 17 00 00       	call   80180a <sys_run_env>
  8000d2:	83 c4 10             	add    $0x10,%esp
	env_sleep(5000) ;
  8000d5:	83 ec 0c             	sub    $0xc,%esp
  8000d8:	68 88 13 00 00       	push   $0x1388
  8000dd:	e8 0a 1a 00 00       	call   801aec <env_sleep>
  8000e2:	83 c4 10             	add    $0x10,%esp
	sys_run_env(envIdProcessB);
  8000e5:	83 ec 0c             	sub    $0xc,%esp
  8000e8:	ff 75 e4             	pushl  -0x1c(%ebp)
  8000eb:	e8 1a 17 00 00       	call   80180a <sys_run_env>
  ...
  8000fe:	e8 77 14 00 00       	call   80157a <sys_calculate_free_frames>
  800103:	83 ec 08             	sub    $0x8,%esp
  800106:	50                   	push   %eax
  800107:	68 78 1e 80 00       	push   $0x801e78
  ...
  80011a:	e8 07 17 00 00       	call   801826 <sys_destroy_env>
  80011f:	83 c4 10             	add    $0x10,%esp
	sys_destroy_env(envIdProcessB);
  800122:	83 ec 0c             	sub    $0xc,%esp
  800125:	ff 75 e4             	pushl  -0x1c(%ebp)
  800128:	e8 f9 16 00 00       	call   801826 <sys_destroy_env>
  80012d:	83 c4 10             	add    $0x10,%esp

	//Checking the number of frames after killing the created environments
	int freeFrames_after = sys_calculate_free_frames() ;
  800130:	e8 45 14 00 00       	call   80157a <sys_calculate_free_frames>
  800135:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int usedDiskPages_after = sys_pf_calculate_allocated_pages() ;
  800138:	e8 dd 14 00 00       	call   80161a <sys_pf_calculate_allocated_pages>
  ...
  80014e:	68 ac 1e 80 00       	push   $0x801eac
  800153:	e8 2d 04 00 00       	call   800585 <cprintf>
  800158:	83 c4 10             	add    $0x10,%esp
				freeFrames_after);
		panic("env_free() does not work correctly... check it again.");
  80015b:	83 ec 04             	sub    $0x4,%esp
  80015e:	68 fc 1e 80 00       	push   $0x801efc
  800163:	6a 23                	push   $0x23
  800165:	68 32 1f 80 00       	push   $0x801f32
...
libmain(int argc, char **argv)
{
  ...
  80019b:	e8 ba 16 00 00       	call   80185a <sys_getenvindex>
  ...
  800206:	e8 5c 14 00 00       	call   801667 <sys_disable_interrupt>
	cprintf("**************************************\n");
  80020b:	83 ec 0c             	sub    $0xc,%esp
  80020e:	68 0c 20 80 00       	push   $0x80200c
  ...
  800234:	52                   	push   %edx
  800235:	50                   	push   %eax
  800236:	68 34 20 80 00       	push   $0x802034
  ...
  800265:	52                   	push   %edx
  800266:	50                   	push   %eax
  800267:	68 5c 20 80 00       	push   $0x80205c
  ...
  800282:	50                   	push   %eax
  800283:	68 b4 20 80 00       	push   $0x8020b4
  800288:	e8 f8 02 00 00       	call   800585 <cprintf>
  80028d:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800290:	83 ec 0c             	sub    $0xc,%esp
  800293:	68 0c 20 80 00       	push   $0x80200c
  800298:	e8 e8 02 00 00       	call   800585 <cprintf>
  80029d:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8002a0:	e8 dc 13 00 00       	call   801681 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8002b8:	e8 69 15 00 00       	call   801826 <sys_destroy_env>
...
exit(void)
{
  ...
  8002c6:	83 ec 08             	sub    $0x8,%esp
	sys_exit_env();
  8002c9:	e8 be 15 00 00       	call   80188c <sys_exit_env>
}
  8002ce:	90                   	nop
  8002cf:	c9                   	leave  
  8002d0:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8002f1:	50                   	push   %eax
  8002f2:	68 c8 20 80 00       	push   $0x8020c8
  ...
  80030a:	50                   	push   %eax
  80030b:	68 cd 20 80 00       	push   $0x8020cd
  ...
  80032f:	68 e9 20 80 00       	push   $0x8020e9
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80035b:	68 ec 20 80 00       	push   $0x8020ec
  800360:	6a 26                	push   $0x26
  800362:	68 38 21 80 00       	push   $0x802138
  ...
  80042d:	68 44 21 80 00       	push   $0x802144
  800432:	6a 3a                	push   $0x3a
  800434:	68 38 21 80 00       	push   $0x802138
  ...
  80049d:	68 98 21 80 00       	push   $0x802198
  8004a2:	6a 44                	push   $0x44
  8004a4:	68 38 21 80 00       	push   $0x802138
...
static void putch(int ch, struct printbuf *b) {
  ...
  8004f5:	51                   	push   %ecx
  8004f6:	52                   	push   %edx
  8004f7:	e8 bd 0f 00 00       	call   8014b9 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  80056d:	50                   	push   %eax
  80056e:	e8 46 0f 00 00       	call   8014b9 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  8005b5:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005b8:	e8 aa 10 00 00       	call   801667 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8005d5:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8005d8:	e8 a4 10 00 00       	call   801681 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800622:	e8 79 15 00 00       	call   801ba0 <__udivdi3>
  ...
  800670:	52                   	push   %edx
  800671:	50                   	push   %eax
  800672:	e8 39 16 00 00       	call   801cb0 <__umoddi3>
  800677:	83 c4 10             	add    $0x10,%esp
  80067a:	05 14 24 80 00       	add    $0x802414,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007cd:	8b 04 85 38 24 80 00 	mov    0x802438(,%eax,4),%eax
  ...
  8008ae:	8b 34 9d 80 22 80 00 	mov    0x802280(,%ebx,4),%esi
  8008b5:	85 f6                	test   %esi,%esi
  8008b7:	75 19                	jne    8008d2 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8008b9:	53                   	push   %ebx
  8008ba:	68 25 24 80 00       	push   $0x802425
  ...
  8008cd:	e9 49 02 00 00       	jmp    800b1b <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8008d2:	56                   	push   %esi
  8008d3:	68 2e 24 80 00       	push   $0x80242e
  ...
  8008fe:	75 05                	jne    800905 <vprintfmt+0x1a6>
				p = "(null)";
  800900:	be 31 24 80 00       	mov    $0x802431,%esi
			if (width > 0 && padc != '-')
...
#endif
		FirstTimeFlag = 0;
  801333:	c7 05 04 30 80 00 00 	movl   $0x0,0x803004
  80133a:	00 00 00 
	}
}
  80133d:	90                   	nop
...
void initialize_dyn_block_system()
{
  ...
  801349:	68 b8 25 80 00       	push   $0x8025b8
  80134e:	6a 21                	push   $0x21
  801350:	68 f2 25 80 00       	push   $0x8025f2
  801355:	e8 77 ef ff ff       	call   8002d1 <_panic>
...
void* malloc(uint32 size)
{
  ...
  80135d:	83 ec 08             	sub    $0x8,%esp
	...
	InitializeUHeap();
  801360:	e8 aa ff ff ff       	call   80130f <InitializeUHeap>
	if (size == 0) return NULL ;
  801365:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  801369:	75 07                	jne    801372 <malloc+0x18>
  80136b:	b8 00 00 00 00       	mov    $0x0,%eax
  801370:	eb 14                	jmp    801386 <malloc+0x2c>
	//==============================================================
	//==============================================================
  ...
  801375:	68 00 26 80 00       	push   $0x802600
  80137a:	6a 39                	push   $0x39
  80137c:	68 f2 25 80 00       	push   $0x8025f2
  801381:	e8 4b ef ff ff       	call   8002d1 <_panic>
...
void free(void* virtual_address)
{
  ...
  801391:	68 28 26 80 00       	push   $0x802628
  801396:	6a 54                	push   $0x54
  801398:	68 f2 25 80 00       	push   $0x8025f2
  80139d:	e8 2f ef ff ff       	call   8002d1 <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8013ab:	88 45 f4             	mov    %al,-0xc(%ebp)
	//==============================================================
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8013ae:	e8 5c ff ff ff       	call   80130f <InitializeUHeap>
	if (size == 0) return NULL ;
  8013b3:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  8013b7:	75 07                	jne    8013c0 <smalloc+0x1e>
  8013b9:	b8 00 00 00 00       	mov    $0x0,%eax
  8013be:	eb 14                	jmp    8013d4 <smalloc+0x32>
	//==============================================================
  ...
  8013c3:	68 4c 26 80 00       	push   $0x80264c
  8013c8:	6a 69                	push   $0x69
  8013ca:	68 f2 25 80 00       	push   $0x8025f2
  8013cf:	e8 fd ee ff ff       	call   8002d1 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8013d9:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8013dc:	e8 2e ff ff ff       	call   80130f <InitializeUHeap>
	//==============================================================
  ...
  8013e4:	68 74 26 80 00       	push   $0x802674
  8013e9:	68 86 00 00 00       	push   $0x86
  8013ee:	68 f2 25 80 00       	push   $0x8025f2
  8013f3:	e8 d9 ee ff ff       	call   8002d1 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8013fb:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8013fe:	e8 0c ff ff ff       	call   80130f <InitializeUHeap>
	//==============================================================
	// [USER HEAP - USER SIDE] realloc
	// Write your code here, remove the panic and write your code
	panic("realloc() is not implemented yet...!!");
  801403:	83 ec 04             	sub    $0x4,%esp
  801406:	68 98 26 80 00       	push   $0x802698
  80140b:	68 b8 00 00 00       	push   $0xb8
  801410:	68 f2 25 80 00       	push   $0x8025f2
  801415:	e8 b7 ee ff ff       	call   8002d1 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801423:	68 c0 26 80 00       	push   $0x8026c0
  801428:	68 cc 00 00 00       	push   $0xcc
  80142d:	68 f2 25 80 00       	push   $0x8025f2
  801432:	e8 9a ee ff ff       	call   8002d1 <_panic>
...
void expand(uint32 newSize)
{
  ...
  801440:	68 e4 26 80 00       	push   $0x8026e4
  801445:	68 d7 00 00 00       	push   $0xd7
  80144a:	68 f2 25 80 00       	push   $0x8025f2
  80144f:	e8 7d ee ff ff       	call   8002d1 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  80145d:	68 e4 26 80 00       	push   $0x8026e4
  801462:	68 dc 00 00 00       	push   $0xdc
  801467:	68 f2 25 80 00       	push   $0x8025f2
  80146c:	e8 60 ee ff ff       	call   8002d1 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  80147a:	68 e4 26 80 00       	push   $0x8026e4
  80147f:	68 e1 00 00 00       	push   $0xe1
  801484:	68 f2 25 80 00       	push   $0x8025f2
  801489:	e8 43 ee ff ff       	call   8002d1 <_panic>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  80150a:	52                   	push   %edx
  80150b:	50                   	push   %eax
  80150c:	6a 05                	push   $0x5
  80150e:	e8 7b ff ff ff       	call   80148e <syscall>
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  80152f:	52                   	push   %edx
  801530:	50                   	push   %eax
  801531:	6a 06                	push   $0x6
  801533:	e8 56 ff ff ff       	call   80148e <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801555:	e8 34 ff ff ff       	call   80148e <syscall>
  80155a:	83 c4 18             	add    $0x18,%esp
}
  80155d:	c9                   	leave  
  80155e:	c3                   	ret    

0080155f <sys_calculate_required_frames>:
...
0080157a <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  801587:	6a 09                	push   $0x9
  801589:	e8 00 ff ff ff       	call   80148e <syscall>
  80158e:	83 c4 18             	add    $0x18,%esp
}
  801591:	c9                   	leave  
  801592:	c3                   	ret    

00801593 <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  8015a2:	e8 e7 fe ff ff       	call   80148e <syscall>
  8015a7:	83 c4 18             	add    $0x18,%esp
}
  8015aa:	c9                   	leave  
  8015ab:	c3                   	ret    

008015ac <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  8015b9:	6a 0b                	push   $0xb
  8015bb:	e8 ce fe ff ff       	call   80148e <syscall>
  8015c0:	83 c4 18             	add    $0x18,%esp
}
  8015c3:	c9                   	leave  
  8015c4:	c3                   	ret    

008015c5 <sys_free_user_mem>:
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8015d6:	e8 b3 fe ff ff       	call   80148e <syscall>
...
008015e1 <sys_allocate_user_mem>:
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8015f0:	6a 10                	push   $0x10
  8015f2:	e8 97 fe ff ff       	call   80148e <syscall>
...
void sys_allocate_chunk(uint32 virtual_address, uint32 size, uint32 perms)
{
  ...
  80160f:	e8 7a fe ff ff       	call   80148e <syscall>
...
0080161a <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801627:	6a 0c                	push   $0xc
  801629:	e8 60 fe ff ff       	call   80148e <syscall>
  80162e:	83 c4 18             	add    $0x18,%esp
}
  801631:	c9                   	leave  
  801632:	c3                   	ret    

00801633 <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801641:	6a 0d                	push   $0xd
  801643:	e8 46 fe ff ff       	call   80148e <syscall>
  801648:	83 c4 18             	add    $0x18,%esp
}
  80164b:	c9                   	leave  
  80164c:	c3                   	ret    

0080164d <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  80165a:	6a 0e                	push   $0xe
  80165c:	e8 2d fe ff ff       	call   80148e <syscall>
...
00801667 <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  801674:	6a 13                	push   $0x13
  801676:	e8 13 fe ff ff       	call   80148e <syscall>
...
sys_enable_interrupt()
{
  ...
  80168e:	6a 14                	push   $0x14
  801690:	e8 f9 fd ff ff       	call   80148e <syscall>
...
sys_cputc(const char c)
{
  ...
  8016b3:	50                   	push   %eax
  8016b4:	6a 15                	push   $0x15
  8016b6:	e8 d3 fd ff ff       	call   80148e <syscall>
...
sys_clear_ffl()
{
  ...
  8016ce:	6a 16                	push   $0x16
  8016d0:	e8 b9 fd ff ff       	call   80148e <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  8016ea:	50                   	push   %eax
  8016eb:	6a 17                	push   $0x17
  8016ed:	e8 9c fd ff ff       	call   80148e <syscall>
  8016f2:	83 c4 18             	add    $0x18,%esp
}
  8016f5:	c9                   	leave  
  8016f6:	c3                   	ret    

008016f7 <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801706:	52                   	push   %edx
  801707:	50                   	push   %eax
  801708:	6a 1a                	push   $0x1a
  80170a:	e8 7f fd ff ff       	call   80148e <syscall>
  80170f:	83 c4 18             	add    $0x18,%esp
}
  801712:	c9                   	leave  
  801713:	c3                   	ret    

00801714 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801723:	52                   	push   %edx
  801724:	50                   	push   %eax
  801725:	6a 18                	push   $0x18
  801727:	e8 62 fd ff ff       	call   80148e <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801741:	52                   	push   %edx
  801742:	50                   	push   %eax
  801743:	6a 19                	push   $0x19
  801745:	e8 44 fd ff ff       	call   80148e <syscall>
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801770:	e8 19 fd ff ff       	call   80148e <syscall>
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  80178d:	e8 fc fc ff ff       	call   80148e <syscall>
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  8017a8:	52                   	push   %edx
  8017a9:	50                   	push   %eax
  8017aa:	6a 1d                	push   $0x1d
  8017ac:	e8 dd fc ff ff       	call   80148e <syscall>
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  8017c5:	52                   	push   %edx
  8017c6:	50                   	push   %eax
  8017c7:	6a 1e                	push   $0x1e
  8017c9:	e8 c0 fc ff ff       	call   80148e <syscall>
  8017ce:	83 c4 18             	add    $0x18,%esp
}
  8017d1:	c9                   	leave  
  8017d2:	c3                   	ret    

008017d3 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  8017e0:	6a 1f                	push   $0x1f
  8017e2:	e8 a7 fc ff ff       	call   80148e <syscall>
  8017e7:	83 c4 18             	add    $0x18,%esp
}
  8017ea:	c9                   	leave  
  8017eb:	c3                   	ret    

008017ec <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8017f4:	ff 75 14             	pushl  0x14(%ebp)
  8017f7:	ff 75 10             	pushl  0x10(%ebp)
  8017fa:	ff 75 0c             	pushl  0xc(%ebp)
  8017fd:	50                   	push   %eax
  8017fe:	6a 20                	push   $0x20
  801800:	e8 89 fc ff ff       	call   80148e <syscall>
  801805:	83 c4 18             	add    $0x18,%esp
}
  801808:	c9                   	leave  
  801809:	c3                   	ret    

0080180a <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  801818:	50                   	push   %eax
  801819:	6a 21                	push   $0x21
  80181b:	e8 6e fc ff ff       	call   80148e <syscall>
...
int sys_destroy_env(int32  envid)
{
  ...
  801837:	e8 52 fc ff ff       	call   80148e <syscall>
  80183c:	83 c4 18             	add    $0x18,%esp
}
  80183f:	c9                   	leave  
  801840:	c3                   	ret    

00801841 <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  80184e:	6a 02                	push   $0x2
  801850:	e8 39 fc ff ff       	call   80148e <syscall>
  801855:	83 c4 18             	add    $0x18,%esp
}
  801858:	c9                   	leave  
  801859:	c3                   	ret    

0080185a <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801867:	6a 03                	push   $0x3
  801869:	e8 20 fc ff ff       	call   80148e <syscall>
  80186e:	83 c4 18             	add    $0x18,%esp
}
  801871:	c9                   	leave  
  801872:	c3                   	ret    

00801873 <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801882:	e8 07 fc ff ff       	call   80148e <syscall>
  801887:	83 c4 18             	add    $0x18,%esp
}
  80188a:	c9                   	leave  
  80188b:	c3                   	ret    

0080188c <sys_exit_env>:
...
void sys_exit_env(void)
{
  ...
  80189b:	e8 ee fb ff ff       	call   80148e <syscall>
...
sys_get_virtual_time()
{
  ...
  8018bf:	e8 ca fb ff ff       	call   80148e <syscall>
...
void sys_move_user_mem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8018ec:	6a 12                	push   $0x12
  8018ee:	e8 9b fb ff ff       	call   80148e <syscall>
...
uint32 sys_rcr2()
{
  ...
  801908:	e8 81 fb ff ff       	call   80148e <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80192d:	e8 5c fb ff ff       	call   80148e <syscall>
...
void rsttst()
{
  ...
  801947:	e8 42 fb ff ff       	call   80148e <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801972:	e8 17 fb ff ff       	call   80148e <syscall>
...
void chktst(uint32 n)
{
  ...
  80198d:	e8 fc fa ff ff       	call   80148e <syscall>
...
void inctst()
{
  ...
  8019a7:	e8 e2 fa ff ff       	call   80148e <syscall>
...
uint32 gettst()
{
  ...
  8019c1:	e8 c8 fa ff ff       	call   80148e <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8019dd:	e8 ac fa ff ff       	call   80148e <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801a0e:	e8 7b fa ff ff       	call   80148e <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801a3f:	e8 4a fa ff ff       	call   80148e <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801a70:	e8 19 fa ff ff       	call   80148e <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801a9f:	e8 ea f9 ff ff       	call   80148e <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801ac2:	e8 c7 f9 ff ff       	call   80148e <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801ae2:	e8 a7 f9 ff ff       	call   80148e <syscall>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801b17:	c1 e0 04             	shl    $0x4,%eax
  801b1a:	89 45 f0             	mov    %eax,-0x10(%ebp)
	uint32 cycles_counter =0;
  801b1d:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)

	struct uint64 baseTime = sys_get_virtual_time() ;
  801b24:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801b27:	83 ec 0c             	sub    $0xc,%esp
  801b2a:	50                   	push   %eax
  801b2b:	e8 76 fd ff ff       	call   8018a6 <sys_get_virtual_time>
  801b30:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  801b33:	eb 41                	jmp    801b76 <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  801b35:	8d 45 e0             	lea    -0x20(%ebp),%eax
  801b38:	83 ec 0c             	sub    $0xc,%esp
  801b3b:	50                   	push   %eax
  801b3c:	e8 65 fd ff ff       	call   8018a6 <sys_get_virtual_time>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801b79:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  801b7c:	72 b7                	jb     801b35 <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  801b84:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  801b87:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  801b8e:	eb 03                	jmp    801b93 <busy_wait+0x12>
  801b90:	ff 45 fc             	incl   -0x4(%ebp)
  801b93:	8b 45 fc             	mov    -0x4(%ebp),%eax
  801b96:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b99:	72 f5                	jb     801b90 <busy_wait+0xf>
	return i;
