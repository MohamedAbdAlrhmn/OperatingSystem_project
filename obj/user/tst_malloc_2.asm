...
void _main(void)
{
  ...
  8000a6:	e8 d0 14 00 00       	call   80157b <malloc>
  ...
  8000fd:	50                   	push   %eax
  8000fe:	e8 78 14 00 00       	call   80157b <malloc>
  ...
  800141:	50                   	push   %eax
  800142:	e8 34 14 00 00       	call   80157b <malloc>
  ...
  80018f:	50                   	push   %eax
  800190:	e8 e6 13 00 00       	call   80157b <malloc>
  ...
  8001df:	50                   	push   %eax
  8001e0:	e8 96 13 00 00       	call   80157b <malloc>
  ...
  800282:	68 b0 1f 80 00       	push   $0x801fb0
  800287:	6a 45                	push   $0x45
  800289:	68 9c 1f 80 00       	push   $0x801f9c
  ...
  8002b7:	68 b0 1f 80 00       	push   $0x801fb0
  8002bc:	6a 46                	push   $0x46
  8002be:	68 9c 1f 80 00       	push   $0x801f9c
  ...
  8002eb:	68 b0 1f 80 00       	push   $0x801fb0
  8002f0:	6a 47                	push   $0x47
  8002f2:	68 9c 1f 80 00       	push   $0x801f9c
  ...
  80031f:	68 b0 1f 80 00       	push   $0x801fb0
  800324:	6a 49                	push   $0x49
  800326:	68 9c 1f 80 00       	push   $0x801f9c
  ...
  800359:	68 b0 1f 80 00       	push   $0x801fb0
  80035e:	6a 4a                	push   $0x4a
  800360:	68 9c 1f 80 00       	push   $0x801f9c
  ...
  80038f:	68 b0 1f 80 00       	push   $0x801fb0
  800394:	6a 4b                	push   $0x4b
  800396:	68 9c 1f 80 00       	push   $0x801f9c
  ...
  8003a3:	68 e8 1f 80 00       	push   $0x801fe8
...
libmain(int argc, char **argv)
{
  ...
  8003bc:	e8 ba 16 00 00       	call   801a7b <sys_getenvindex>
  ...
  8003e3:	a3 20 30 80 00       	mov    %eax,0x803020
  ...
  800411:	a3 00 30 80 00       	mov    %eax,0x803000
  ...
  800427:	e8 5c 14 00 00       	call   801888 <sys_disable_interrupt>
	cprintf("**************************************\n");
  80042c:	83 ec 0c             	sub    $0xc,%esp
  80042f:	68 3c 20 80 00       	push   $0x80203c
  ...
  800455:	52                   	push   %edx
  800456:	50                   	push   %eax
  800457:	68 64 20 80 00       	push   $0x802064
  ...
  800486:	52                   	push   %edx
  800487:	50                   	push   %eax
  800488:	68 8c 20 80 00       	push   $0x80208c
  ...
  8004a3:	50                   	push   %eax
  8004a4:	68 e4 20 80 00       	push   $0x8020e4
  8004a9:	e8 f8 02 00 00       	call   8007a6 <cprintf>
  8004ae:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  8004b1:	83 ec 0c             	sub    $0xc,%esp
  8004b4:	68 3c 20 80 00       	push   $0x80203c
  8004b9:	e8 e8 02 00 00       	call   8007a6 <cprintf>
  8004be:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8004c1:	e8 dc 13 00 00       	call   8018a2 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8004d9:	e8 69 15 00 00       	call   801a47 <sys_destroy_env>
...
exit(void)
{
  ...
  8004e7:	83 ec 08             	sub    $0x8,%esp
	sys_exit_env();
  8004ea:	e8 be 15 00 00       	call   801aad <sys_exit_env>
}
  8004ef:	90                   	nop
  8004f0:	c9                   	leave  
  8004f1:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800550:	68 19 21 80 00       	push   $0x802119
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80057c:	68 1c 21 80 00       	push   $0x80211c
  800581:	6a 26                	push   $0x26
  800583:	68 68 21 80 00       	push   $0x802168
  ...
  80064e:	68 74 21 80 00       	push   $0x802174
  800653:	6a 3a                	push   $0x3a
  800655:	68 68 21 80 00       	push   $0x802168
  ...
  80067e:	a1 20 30 80 00       	mov    0x803020,%eax
  ...
  8006be:	68 c8 21 80 00       	push   $0x8021c8
  8006c3:	6a 44                	push   $0x44
  8006c5:	68 68 21 80 00       	push   $0x802168
...
static void putch(int ch, struct printbuf *b) {
  ...
  800716:	51                   	push   %ecx
  800717:	52                   	push   %edx
  800718:	e8 bd 0f 00 00       	call   8016da <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  80076f:	83 c4 10             	add    $0x10,%esp
	sys_cputs(b.buf, b.idx, printProgName);
  800772:	a0 24 30 80 00       	mov    0x803024,%al
  ...
  80078e:	50                   	push   %eax
  80078f:	e8 46 0f 00 00       	call   8016da <sys_cputs>
  800794:	83 c4 10             	add    $0x10,%esp

	printProgName = 0;
  800797:	c6 05 24 30 80 00 00 	movb   $0x0,0x803024
	return b.cnt;
...
int cprintf(const char *fmt, ...) {
  ...
  8007a9:	83 ec 18             	sub    $0x18,%esp
	...
	int cnt;
	printProgName = 1 ;
  8007ac:	c6 05 24 30 80 00 01 	movb   $0x1,0x803024
	va_start(ap, fmt);
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  8007d6:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8007d9:	e8 aa 10 00 00       	call   801888 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8007f6:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8007f9:	e8 a4 10 00 00       	call   8018a2 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800843:	e8 c8 14 00 00       	call   801d10 <__udivdi3>
  ...
  800891:	52                   	push   %edx
  800892:	50                   	push   %eax
  800893:	e8 88 15 00 00       	call   801e20 <__umoddi3>
  800898:	83 c4 10             	add    $0x10,%esp
  80089b:	05 34 24 80 00       	add    $0x802434,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8009ee:	8b 04 85 58 24 80 00 	mov    0x802458(,%eax,4),%eax
  ...
  800acf:	8b 34 9d a0 22 80 00 	mov    0x8022a0(,%ebx,4),%esi
  800ad6:	85 f6                	test   %esi,%esi
  800ad8:	75 19                	jne    800af3 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800ada:	53                   	push   %ebx
  800adb:	68 45 24 80 00       	push   $0x802445
  ...
  800aee:	e9 49 02 00 00       	jmp    800d3c <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800af3:	56                   	push   %esi
  800af4:	68 4e 24 80 00       	push   $0x80244e
  ...
  800b1f:	75 05                	jne    800b26 <vprintfmt+0x1a6>
				p = "(null)";
  800b21:	be 51 24 80 00       	mov    $0x802451,%esi
			if (width > 0 && padc != '-')
...
void InitializeUHeap()
{
  ...
  801533:	83 ec 08             	sub    $0x8,%esp
	if(FirstTimeFlag)
  801536:	a1 04 30 80 00       	mov    0x803004,%eax
  ...
  801547:	68 b0 25 80 00       	push   $0x8025b0
...
#endif
		FirstTimeFlag = 0;
  801554:	c7 05 04 30 80 00 00 	movl   $0x0,0x803004
  80155b:	00 00 00 
	}
}
  80155e:	90                   	nop
...
void initialize_dyn_block_system()
{
  ...
  80156a:	68 d8 25 80 00       	push   $0x8025d8
  80156f:	6a 21                	push   $0x21
  801571:	68 12 26 80 00       	push   $0x802612
  801576:	e8 77 ef ff ff       	call   8004f2 <_panic>
...
void* malloc(uint32 size)
{
  ...
  801596:	68 20 26 80 00       	push   $0x802620
  80159b:	6a 39                	push   $0x39
  80159d:	68 12 26 80 00       	push   $0x802612
  8015a2:	e8 4b ef ff ff       	call   8004f2 <_panic>
...
void free(void* virtual_address)
{
  ...
  8015b2:	68 48 26 80 00       	push   $0x802648
  8015b7:	6a 54                	push   $0x54
  8015b9:	68 12 26 80 00       	push   $0x802612
  8015be:	e8 2f ef ff ff       	call   8004f2 <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8015cc:	88 45 f4             	mov    %al,-0xc(%ebp)
	//==============================================================
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8015cf:	e8 5c ff ff ff       	call   801530 <InitializeUHeap>
	if (size == 0) return NULL ;
  8015d4:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  8015d8:	75 07                	jne    8015e1 <smalloc+0x1e>
  8015da:	b8 00 00 00 00       	mov    $0x0,%eax
  8015df:	eb 14                	jmp    8015f5 <smalloc+0x32>
	//==============================================================
  ...
  8015e4:	68 6c 26 80 00       	push   $0x80266c
  8015e9:	6a 69                	push   $0x69
  8015eb:	68 12 26 80 00       	push   $0x802612
  8015f0:	e8 fd ee ff ff       	call   8004f2 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8015fa:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8015fd:	e8 2e ff ff ff       	call   801530 <InitializeUHeap>
	//==============================================================
  ...
  801605:	68 94 26 80 00       	push   $0x802694
  80160a:	68 86 00 00 00       	push   $0x86
  80160f:	68 12 26 80 00       	push   $0x802612
  801614:	e8 d9 ee ff ff       	call   8004f2 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  80161c:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  80161f:	e8 0c ff ff ff       	call   801530 <InitializeUHeap>
	//==============================================================
	// [USER HEAP - USER SIDE] realloc
	// Write your code here, remove the panic and write your code
	panic("realloc() is not implemented yet...!!");
  801624:	83 ec 04             	sub    $0x4,%esp
  801627:	68 b8 26 80 00       	push   $0x8026b8
  80162c:	68 b8 00 00 00       	push   $0xb8
  801631:	68 12 26 80 00       	push   $0x802612
  801636:	e8 b7 ee ff ff       	call   8004f2 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801644:	68 e0 26 80 00       	push   $0x8026e0
  801649:	68 cc 00 00 00       	push   $0xcc
  80164e:	68 12 26 80 00       	push   $0x802612
  801653:	e8 9a ee ff ff       	call   8004f2 <_panic>
...
void expand(uint32 newSize)
{
  ...
  801661:	68 04 27 80 00       	push   $0x802704
  801666:	68 d7 00 00 00       	push   $0xd7
  80166b:	68 12 26 80 00       	push   $0x802612
  801670:	e8 7d ee ff ff       	call   8004f2 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  80167e:	68 04 27 80 00       	push   $0x802704
  801683:	68 dc 00 00 00       	push   $0xdc
  801688:	68 12 26 80 00       	push   $0x802612
  80168d:	e8 60 ee ff ff       	call   8004f2 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  80169b:	68 04 27 80 00       	push   $0x802704
  8016a0:	68 e1 00 00 00       	push   $0xe1
  8016a5:	68 12 26 80 00       	push   $0x802612
  8016aa:	e8 43 ee ff ff       	call   8004f2 <_panic>
