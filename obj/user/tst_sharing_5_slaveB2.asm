...
_main(void)
{
  ...
  8000a2:	e8 98 12 00 00       	call   80133f <malloc>
  8000a7:	83 c4 10             	add    $0x10,%esp
	/*=================================================*/

	uint32 *z;
	z = sget(sys_getparentenvid(),"z");
  8000aa:	e8 a9 17 00 00       	call   801858 <sys_getparentenvid>
  8000af:	83 ec 08             	sub    $0x8,%esp
  8000b2:	68 39 1e 80 00       	push   $0x801e39
  8000b7:	50                   	push   %eax
  8000b8:	e8 fe 12 00 00       	call   8013bb <sget>
  8000bd:	83 c4 10             	add    $0x10,%esp
  8000c0:	89 45 ec             	mov    %eax,-0x14(%ebp)
	cprintf("Slave B2 env used z (getSharedObject)\n");
  8000c3:	83 ec 0c             	sub    $0xc,%esp
  8000c6:	68 3c 1e 80 00       	push   $0x801e3c
  8000cb:	e8 9a 04 00 00       	call   80056a <cprintf>
  8000d0:	83 c4 10             	add    $0x10,%esp
	//To indicate that it's successfully got z
	inctst();
  8000d3:	e8 a5 18 00 00       	call   80197d <inctst>

	cprintf("Slave B2 please be patient ...\n");
  8000d8:	83 ec 0c             	sub    $0xc,%esp
  8000db:	68 64 1e 80 00       	push   $0x801e64
  ...
  8000f0:	e8 dc 19 00 00       	call   801ad1 <env_sleep>
  8000f5:	83 c4 10             	add    $0x10,%esp
	//to ensure that the other environments completed successfully
	while (gettst()!=2) ;// panic("test failed");
  8000f8:	90                   	nop
  8000f9:	e8 99 18 00 00       	call   801997 <gettst>
  8000fe:	83 f8 02             	cmp    $0x2,%eax
  800101:	75 f6                	jne    8000f9 <_main+0xc1>

	int freeFrames = sys_calculate_free_frames() ;
  800103:	e8 57 14 00 00       	call   80155f <sys_calculate_free_frames>
  800108:	89 45 e8             	mov    %eax,-0x18(%ebp)

	sfree(z);
  80010b:	83 ec 0c             	sub    $0xc,%esp
  80010e:	ff 75 ec             	pushl  -0x14(%ebp)
  800111:	e8 e9 12 00 00       	call   8013ff <sfree>
  800116:	83 c4 10             	add    $0x10,%esp
	cprintf("Slave B2 env removed z\n");
  800119:	83 ec 0c             	sub    $0xc,%esp
  80011c:	68 84 1e 80 00       	push   $0x801e84
  ...
  800130:	e8 2a 14 00 00       	call   80155f <sys_calculate_free_frames>
  ...
  800146:	68 9c 1e 80 00       	push   $0x801e9c
  80014b:	6a 2a                	push   $0x2a
  80014d:	68 1c 1e 80 00       	push   $0x801e1c
  800152:	e8 5f 01 00 00       	call   8002b6 <_panic>


	cprintf("Step B completed successfully!!\n\n\n");
  800157:	83 ec 0c             	sub    $0xc,%esp
  80015a:	68 3c 1f 80 00       	push   $0x801f3c
  ...
  80016a:	68 60 1f 80 00       	push   $0x801f60
...
libmain(int argc, char **argv)
{
  ...
  800180:	e8 ba 16 00 00       	call   80183f <sys_getenvindex>
  ...
  8001a7:	a3 20 30 80 00       	mov    %eax,0x803020
  ...
  8001c5:	a3 00 30 80 00       	mov    %eax,0x803000
  ...
  8001d5:	a3 00 30 80 00       	mov    %eax,0x803000
  ...
  8001eb:	e8 5c 14 00 00       	call   80164c <sys_disable_interrupt>
	cprintf("**************************************\n");
  8001f0:	83 ec 0c             	sub    $0xc,%esp
  8001f3:	68 c4 1f 80 00       	push   $0x801fc4
  ...
  800219:	52                   	push   %edx
  80021a:	50                   	push   %eax
  80021b:	68 ec 1f 80 00       	push   $0x801fec
  ...
  80024a:	52                   	push   %edx
  80024b:	50                   	push   %eax
  80024c:	68 14 20 80 00       	push   $0x802014
  ...
  800267:	50                   	push   %eax
  800268:	68 6c 20 80 00       	push   $0x80206c
  80026d:	e8 f8 02 00 00       	call   80056a <cprintf>
  800272:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800275:	83 ec 0c             	sub    $0xc,%esp
  800278:	68 c4 1f 80 00       	push   $0x801fc4
  80027d:	e8 e8 02 00 00       	call   80056a <cprintf>
  800282:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  800285:	e8 dc 13 00 00       	call   801666 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  80029d:	e8 69 15 00 00       	call   80180b <sys_destroy_env>
...
exit(void)
{
  ...
  8002ab:	83 ec 08             	sub    $0x8,%esp
	sys_exit_env();
  8002ae:	e8 be 15 00 00       	call   801871 <sys_exit_env>
}
  8002b3:	90                   	nop
  8002b4:	c9                   	leave  
  8002b5:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8002c2:	89 45 f4             	mov    %eax,-0xc(%ebp)
	...
	if (argv0)
  8002c5:	a1 5c 31 80 00       	mov    0x80315c,%eax
  8002ca:	85 c0                	test   %eax,%eax
  8002cc:	74 16                	je     8002e4 <_panic+0x2e>
		cprintf("%s: ", argv0);
  8002ce:	a1 5c 31 80 00       	mov    0x80315c,%eax
  ...
  8002ef:	50                   	push   %eax
  8002f0:	68 85 20 80 00       	push   $0x802085
  ...
  800314:	68 a1 20 80 00       	push   $0x8020a1
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800340:	68 a4 20 80 00       	push   $0x8020a4
  800345:	6a 26                	push   $0x26
  800347:	68 f0 20 80 00       	push   $0x8020f0
  ...
  800412:	68 fc 20 80 00       	push   $0x8020fc
  800417:	6a 3a                	push   $0x3a
  800419:	68 f0 20 80 00       	push   $0x8020f0
  ...
  800482:	68 50 21 80 00       	push   $0x802150
  800487:	6a 44                	push   $0x44
  800489:	68 f0 20 80 00       	push   $0x8020f0
...
static void putch(int ch, struct printbuf *b) {
  ...
  8004da:	51                   	push   %ecx
  8004db:	52                   	push   %edx
  8004dc:	e8 bd 0f 00 00       	call   80149e <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800552:	50                   	push   %eax
  800553:	e8 46 0f 00 00       	call   80149e <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  80059a:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80059d:	e8 aa 10 00 00       	call   80164c <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8005ba:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8005bd:	e8 a4 10 00 00       	call   801666 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800607:	e8 7c 15 00 00       	call   801b88 <__udivdi3>
  ...
  800655:	52                   	push   %edx
  800656:	50                   	push   %eax
  800657:	e8 3c 16 00 00       	call   801c98 <__umoddi3>
  80065c:	83 c4 10             	add    $0x10,%esp
  80065f:	05 b4 23 80 00       	add    $0x8023b4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007b2:	8b 04 85 d8 23 80 00 	mov    0x8023d8(,%eax,4),%eax
  ...
  800893:	8b 34 9d 20 22 80 00 	mov    0x802220(,%ebx,4),%esi
  80089a:	85 f6                	test   %esi,%esi
  80089c:	75 19                	jne    8008b7 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80089e:	53                   	push   %ebx
  80089f:	68 c5 23 80 00       	push   $0x8023c5
  ...
  8008b2:	e9 49 02 00 00       	jmp    800b00 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8008b7:	56                   	push   %esi
  8008b8:	68 ce 23 80 00       	push   $0x8023ce
  ...
  8008e3:	75 05                	jne    8008ea <vprintfmt+0x1a6>
				p = "(null)";
  8008e5:	be d1 23 80 00       	mov    $0x8023d1,%esi
			if (width > 0 && padc != '-')
...
void InitializeUHeap()
{
  ...
  8012f7:	83 ec 08             	sub    $0x8,%esp
	if(FirstTimeFlag)
  8012fa:	a1 04 30 80 00       	mov    0x803004,%eax
  ...
  80130b:	68 30 25 80 00       	push   $0x802530
...
#endif
		FirstTimeFlag = 0;
  801318:	c7 05 04 30 80 00 00 	movl   $0x0,0x803004
  80131f:	00 00 00 
	}
}
  801322:	90                   	nop
...
void initialize_dyn_block_system()
{
  ...
  80132e:	68 58 25 80 00       	push   $0x802558
  801333:	6a 21                	push   $0x21
  801335:	68 92 25 80 00       	push   $0x802592
  80133a:	e8 77 ef ff ff       	call   8002b6 <_panic>
...
void* malloc(uint32 size)
{
  ...
  801342:	83 ec 08             	sub    $0x8,%esp
	...
	InitializeUHeap();
  801345:	e8 aa ff ff ff       	call   8012f4 <InitializeUHeap>
	if (size == 0) return NULL ;
  80134a:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
  80134e:	75 07                	jne    801357 <malloc+0x18>
  801350:	b8 00 00 00 00       	mov    $0x0,%eax
  801355:	eb 14                	jmp    80136b <malloc+0x2c>
	//==============================================================
	//==============================================================
  ...
  80135a:	68 a0 25 80 00       	push   $0x8025a0
  80135f:	6a 39                	push   $0x39
  801361:	68 92 25 80 00       	push   $0x802592
  801366:	e8 4b ef ff ff       	call   8002b6 <_panic>
...
void free(void* virtual_address)
{
  ...
  801376:	68 c8 25 80 00       	push   $0x8025c8
  80137b:	6a 54                	push   $0x54
  80137d:	68 92 25 80 00       	push   $0x802592
  801382:	e8 2f ef ff ff       	call   8002b6 <_panic>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801390:	88 45 f4             	mov    %al,-0xc(%ebp)
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  801393:	e8 5c ff ff ff       	call   8012f4 <InitializeUHeap>
	if (size == 0) return NULL ;
  801398:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  80139c:	75 07                	jne    8013a5 <smalloc+0x1e>
  80139e:	b8 00 00 00 00       	mov    $0x0,%eax
  8013a3:	eb 14                	jmp    8013b9 <smalloc+0x32>
	//==============================================================
  ...
  8013a8:	68 ec 25 80 00       	push   $0x8025ec
  8013ad:	6a 69                	push   $0x69
  8013af:	68 92 25 80 00       	push   $0x802592
  8013b4:	e8 fd ee ff ff       	call   8002b6 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8013be:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8013c1:	e8 2e ff ff ff       	call   8012f4 <InitializeUHeap>
	//==============================================================
  ...
  8013c9:	68 14 26 80 00       	push   $0x802614
  8013ce:	68 86 00 00 00       	push   $0x86
  8013d3:	68 92 25 80 00       	push   $0x802592
  8013d8:	e8 d9 ee ff ff       	call   8002b6 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8013e0:	83 ec 08             	sub    $0x8,%esp
	...
	//DON'T CHANGE THIS CODE========================================
	InitializeUHeap();
  8013e3:	e8 0c ff ff ff       	call   8012f4 <InitializeUHeap>
	//==============================================================
	// [USER HEAP - USER SIDE] realloc
	// Write your code here, remove the panic and write your code
	panic("realloc() is not implemented yet...!!");
  8013e8:	83 ec 04             	sub    $0x4,%esp
  8013eb:	68 38 26 80 00       	push   $0x802638
  8013f0:	68 b8 00 00 00       	push   $0xb8
  8013f5:	68 92 25 80 00       	push   $0x802592
  8013fa:	e8 b7 ee ff ff       	call   8002b6 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801408:	68 60 26 80 00       	push   $0x802660
  80140d:	68 cc 00 00 00       	push   $0xcc
  801412:	68 92 25 80 00       	push   $0x802592
  801417:	e8 9a ee ff ff       	call   8002b6 <_panic>
...
void expand(uint32 newSize)
{
  ...
  801425:	68 84 26 80 00       	push   $0x802684
  80142a:	68 d7 00 00 00       	push   $0xd7
  80142f:	68 92 25 80 00       	push   $0x802592
  801434:	e8 7d ee ff ff       	call   8002b6 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801442:	68 84 26 80 00       	push   $0x802684
  801447:	68 dc 00 00 00       	push   $0xdc
  80144c:	68 92 25 80 00       	push   $0x802592
  801451:	e8 60 ee ff ff       	call   8002b6 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  80145f:	68 84 26 80 00       	push   $0x802684
  801464:	68 e1 00 00 00       	push   $0xe1
  801469:	68 92 25 80 00       	push   $0x802592
  80146e:	e8 43 ee ff ff       	call   8002b6 <_panic>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  8014ef:	52                   	push   %edx
  8014f0:	50                   	push   %eax
  8014f1:	6a 05                	push   $0x5
  8014f3:	e8 7b ff ff ff       	call   801473 <syscall>
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801518:	e8 56 ff ff ff       	call   801473 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  80153a:	e8 34 ff ff ff       	call   801473 <syscall>
...
uint32 sys_calculate_free_frames()
{
  ...
  80156e:	e8 00 ff ff ff       	call   801473 <syscall>
...
uint32 sys_calculate_modified_frames()
{
  ...
  801587:	e8 e7 fe ff ff       	call   801473 <syscall>
...
uint32 sys_calculate_notmod_frames()
{
  ...
  80159e:	6a 0b                	push   $0xb
  8015a0:	e8 ce fe ff ff       	call   801473 <syscall>
  8015a5:	83 c4 18             	add    $0x18,%esp
}
  8015a8:	c9                   	leave  
  8015a9:	c3                   	ret    

008015aa <sys_free_user_mem>:
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8015bb:	e8 b3 fe ff ff       	call   801473 <syscall>
...
008015c6 <sys_allocate_user_mem>:
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8015d5:	6a 10                	push   $0x10
  8015d7:	e8 97 fe ff ff       	call   801473 <syscall>
...
void sys_allocate_chunk(uint32 virtual_address, uint32 size, uint32 perms)
{
  ...
  8015f2:	6a 11                	push   $0x11
  8015f4:	e8 7a fe ff ff       	call   801473 <syscall>
...
008015ff <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  80160c:	6a 0c                	push   $0xc
  80160e:	e8 60 fe ff ff       	call   801473 <syscall>
  801613:	83 c4 18             	add    $0x18,%esp
}
  801616:	c9                   	leave  
  801617:	c3                   	ret    

00801618 <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801628:	e8 46 fe ff ff       	call   801473 <syscall>
  80162d:	83 c4 18             	add    $0x18,%esp
}
  801630:	c9                   	leave  
  801631:	c3                   	ret    

00801632 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  801641:	e8 2d fe ff ff       	call   801473 <syscall>
...
0080164c <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  80165b:	e8 13 fe ff ff       	call   801473 <syscall>
...
sys_enable_interrupt()
{
  ...
  801675:	e8 f9 fd ff ff       	call   801473 <syscall>
...
sys_cputc(const char c)
{
  ...
  80168c:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  ...
  80169b:	e8 d3 fd ff ff       	call   801473 <syscall>
...
sys_clear_ffl()
{
  ...
  8016b5:	e8 b9 fd ff ff       	call   801473 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  8016d2:	e8 9c fd ff ff       	call   801473 <syscall>
  8016d7:	83 c4 18             	add    $0x18,%esp
}
  8016da:	c9                   	leave  
  8016db:	c3                   	ret    

008016dc <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8016eb:	52                   	push   %edx
  8016ec:	50                   	push   %eax
  8016ed:	6a 1a                	push   $0x1a
  8016ef:	e8 7f fd ff ff       	call   801473 <syscall>
  8016f4:	83 c4 18             	add    $0x18,%esp
}
  8016f7:	c9                   	leave  
  8016f8:	c3                   	ret    

008016f9 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801708:	52                   	push   %edx
  801709:	50                   	push   %eax
  80170a:	6a 18                	push   $0x18
  80170c:	e8 62 fd ff ff       	call   801473 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80172a:	e8 44 fd ff ff       	call   801473 <syscall>
...
00801735 <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801741:	8b 4d 14             	mov    0x14(%ebp),%ecx
  ...
  801752:	50                   	push   %eax
  801753:	6a 1b                	push   $0x1b
  801755:	e8 19 fd ff ff       	call   801473 <syscall>
  80175a:	83 c4 18             	add    $0x18,%esp
}
  80175d:	c9                   	leave  
  80175e:	c3                   	ret    

0080175f <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  80176e:	52                   	push   %edx
  80176f:	50                   	push   %eax
  801770:	6a 1c                	push   $0x1c
  801772:	e8 fc fc ff ff       	call   801473 <syscall>
  801777:	83 c4 18             	add    $0x18,%esp
}
  80177a:	c9                   	leave  
  80177b:	c3                   	ret    

0080177c <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  80178d:	52                   	push   %edx
  80178e:	50                   	push   %eax
  80178f:	6a 1d                	push   $0x1d
  801791:	e8 dd fc ff ff       	call   801473 <syscall>
  801796:	83 c4 18             	add    $0x18,%esp
}
  801799:	c9                   	leave  
  80179a:	c3                   	ret    

0080179b <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  8017aa:	52                   	push   %edx
  8017ab:	50                   	push   %eax
  8017ac:	6a 1e                	push   $0x1e
  8017ae:	e8 c0 fc ff ff       	call   801473 <syscall>
  8017b3:	83 c4 18             	add    $0x18,%esp
}
  8017b6:	c9                   	leave  
  8017b7:	c3                   	ret    

008017b8 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  8017c7:	e8 a7 fc ff ff       	call   801473 <syscall>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  8017e2:	50                   	push   %eax
  8017e3:	6a 20                	push   $0x20
  8017e5:	e8 89 fc ff ff       	call   801473 <syscall>
...
sys_run_env(int32 envId)
{
  ...
  8017fd:	50                   	push   %eax
  8017fe:	6a 21                	push   $0x21
  801800:	e8 6e fc ff ff       	call   801473 <syscall>
...
int sys_destroy_env(int32  envid)
{
  ...
  801819:	50                   	push   %eax
  80181a:	6a 22                	push   $0x22
  80181c:	e8 52 fc ff ff       	call   801473 <syscall>
...
int32 sys_getenvid(void)
{
  ...
  801833:	6a 02                	push   $0x2
  801835:	e8 39 fc ff ff       	call   801473 <syscall>
...
int32 sys_getenvindex(void)
{
  ...
  80184c:	6a 03                	push   $0x3
  80184e:	e8 20 fc ff ff       	call   801473 <syscall>
...
int32 sys_getparentenvid(void)
{
  ...
  801865:	6a 04                	push   $0x4
  801867:	e8 07 fc ff ff       	call   801473 <syscall>
...
void sys_exit_env(void)
{
  ...
  80187e:	6a 23                	push   $0x23
  801880:	e8 ee fb ff ff       	call   801473 <syscall>
...
sys_get_virtual_time()
{
  ...
  8018a4:	e8 ca fb ff ff       	call   801473 <syscall>
...
void sys_move_user_mem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8018d1:	6a 12                	push   $0x12
  8018d3:	e8 9b fb ff ff       	call   801473 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8018eb:	6a 25                	push   $0x25
  8018ed:	e8 81 fb ff ff       	call   801473 <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801912:	e8 5c fb ff ff       	call   801473 <syscall>
...
void rsttst()
{
  ...
  80192c:	e8 42 fb ff ff       	call   801473 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801955:	6a 27                	push   $0x27
  801957:	e8 17 fb ff ff       	call   801473 <syscall>
...
void chktst(uint32 n)
{
  ...
  801972:	e8 fc fa ff ff       	call   801473 <syscall>
...
void inctst()
{
  ...
  80198a:	6a 2a                	push   $0x2a
  80198c:	e8 e2 fa ff ff       	call   801473 <syscall>
...
uint32 gettst()
{
  ...
  8019a4:	6a 2b                	push   $0x2b
  8019a6:	e8 c8 fa ff ff       	call   801473 <syscall>
  8019ab:	83 c4 18             	add    $0x18,%esp
}
  8019ae:	c9                   	leave  
  8019af:	c3                   	ret    

008019b0 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8019c2:	e8 ac fa ff ff       	call   801473 <syscall>
  8019c7:	83 c4 18             	add    $0x18,%esp
  8019ca:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8019cd:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8019d1:	75 07                	jne    8019da <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8019d3:	b8 01 00 00 00       	mov    $0x1,%eax
  8019d8:	eb 05                	jmp    8019df <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008019e1 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8019f3:	e8 7b fa ff ff       	call   801473 <syscall>
  8019f8:	83 c4 18             	add    $0x18,%esp
  8019fb:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  8019fe:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  801a02:	75 07                	jne    801a0b <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  801a04:	b8 01 00 00 00       	mov    $0x1,%eax
  801a09:	eb 05                	jmp    801a10 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00801a12 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801a24:	e8 4a fa ff ff       	call   801473 <syscall>
  801a29:	83 c4 18             	add    $0x18,%esp
  801a2c:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  801a2f:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  801a33:	75 07                	jne    801a3c <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  801a35:	b8 01 00 00 00       	mov    $0x1,%eax
  801a3a:	eb 05                	jmp    801a41 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00801a43 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801a55:	e8 19 fa ff ff       	call   801473 <syscall>
  801a5a:	83 c4 18             	add    $0x18,%esp
  801a5d:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  801a60:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  801a64:	75 07                	jne    801a6d <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  801a66:	b8 01 00 00 00       	mov    $0x1,%eax
  801a6b:	eb 05                	jmp    801a72 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00801a74 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801a82:	6a 2d                	push   $0x2d
  801a84:	e8 ea f9 ff ff       	call   801473 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801aa3:	52                   	push   %edx
  801aa4:	50                   	push   %eax
  801aa5:	6a 2e                	push   $0x2e
  801aa7:	e8 c7 f9 ff ff       	call   801473 <syscall>
...
00801ab4 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801ac3:	52                   	push   %edx
  801ac4:	50                   	push   %eax
  801ac5:	6a 2f                	push   $0x2f
  801ac7:	e8 a7 f9 ff ff       	call   801473 <syscall>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801b09:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801b0c:	83 ec 0c             	sub    $0xc,%esp
  801b0f:	50                   	push   %eax
  801b10:	e8 76 fd ff ff       	call   80188b <sys_get_virtual_time>
  801b15:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  801b18:	eb 41                	jmp    801b5b <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  801b1a:	8d 45 e0             	lea    -0x20(%ebp),%eax
  801b1d:	83 ec 0c             	sub    $0xc,%esp
  801b20:	50                   	push   %eax
  801b21:	e8 65 fd ff ff       	call   80188b <sys_get_virtual_time>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801b61:	72 b7                	jb     801b1a <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  801b69:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  801b6c:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  801b73:	eb 03                	jmp    801b78 <busy_wait+0x12>
  801b75:	ff 45 fc             	incl   -0x4(%ebp)
  801b78:	8b 45 fc             	mov    -0x4(%ebp),%eax
  801b7b:	3b 45 08             	cmp    0x8(%ebp),%eax
  801b7e:	72 f5                	jb     801b75 <busy_wait+0xf>
	return i;
